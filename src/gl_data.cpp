...
const std::vector<std::vector<int>> GLData::partition(const GLData &data) {
...
void GLData::triangulate(GLData &data, std::vector<int> indices, int &start_index, int &indices_index) {
	const int num_verts = indices.size();
